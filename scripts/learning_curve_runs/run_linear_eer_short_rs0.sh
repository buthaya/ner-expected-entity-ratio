# Learning curve experiment: EER on linear documents with annotations of varying coverage, rs0
RUN_JUPYTER=true
...
# tacl-eer_eng-c_P-100_linear_rs0_eer
DATASET_LABEL=P-100_linear_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=54.80.185.233\
 PRIVATE_IP=172.31.43.61\
...
# tacl-eer_eng-c_P-500_linear_rs0_eer
DATASET_LABEL=P-500_linear_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=54.198.96.38\
...
# tacl-eer_eng-c_P-1000_linear_rs0_eer
DATASET_LABEL=P-1000_linear_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=52.70.8.158\
 PRIVATE_IP=172.31.32.238\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
...
# tacl-eer_eng-c_P-5000_linear_rs0_eer
DATASET_LABEL=P-5000_linear_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.84.147.112\
 PRIVATE_IP=172.31.44.54\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
...
# tacl-eer_eng-c_P-10000_linear_rs0_eer
DATASET_LABEL=P-10000_linear_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.81.54.206\
 PRIVATE_IP=172.31.40.123\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
