# Learning curve experiment: EER on documents with annotations of varying coverage, rs1
RUN_JUPYTER=true
...
# tacl-eer_eng-c_P-100_rs1_eer
DATASET_LABEL=P-100_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=18.207.241.50\
 PRIVATE_IP=172.31.56.104\
...
# tacl-eer_eng-c_P-500_rs1_eer
DATASET_LABEL=P-500_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.235.21.197\
 PRIVATE_IP=172.31.58.165\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
...
# tacl-eer_eng-c_P-1000_rs1_eer
DATASET_LABEL=P-1000_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.236.5.130\
 PRIVATE_IP=172.31.50.17\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
...
# tacl-eer_eng-c_P-5000_rs1_eer
DATASET_LABEL=P-5000_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=35.175.180.54\
...
# tacl-eer_eng-c_P-10000_rs1_eer
DATASET_LABEL=P-10000_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.226.250.85\
 PRIVATE_IP=172.31.51.197\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
...
# tacl-eer_eng-c_gold_rs1_eer
DATASET_LABEL=gold_rs$RANDOM_SEED
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.238.171.148\
 PRIVATE_IP=172.31.59.206\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=$LANG_LABEL\
 DATASET_LABEL=$DATASET_LABEL\
