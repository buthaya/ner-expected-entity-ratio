...
do
    ...
    python -m ml.cmd.convert_ontonotes_data  data/ontonotes5/processed/$LANG/\ $ONTO_PATH/data/files/data/$LANG
    --as-sentences --is-complete

    mkdir -p data/ontonotes5/processed_docs/$LANG
    python -m ml.cmd.convert_ontonotes_data  data/ontonotes5/processed_docs/$LANG/\ $ONTO_PATH/data/files/data/$LANG
    --is-complete
done