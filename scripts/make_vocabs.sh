...
python -m ml.cmd.make_vocab /gpfsdswork/dataset/roberta-base data/ontonotes5/processed/english/train.jsonl data/ontonotes5/processed/roberta-entity.vocab
python -m ml.cmd.make_vocab /gpfsdswork/dataset/bert-base-multilingual-cased data/ontonotes5/processed/chinese/train.jsonl data/ontonotes5/processed/mbert-entity.vocab
