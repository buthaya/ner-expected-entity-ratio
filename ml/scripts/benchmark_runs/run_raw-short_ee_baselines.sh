...
# Conll english
# tacl-eer_eng-c_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=34.239.227.242\
 PRIVATE_IP=172.31.1.134\
...
# Conll german
# tacl-eer_deu_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.237.50.226\
 PRIVATE_IP=172.31.11.144\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=deu\
 DATASET_LABEL=$DATASET_LABEL\
...
# Conll spanish
# tacl-eer_esp_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.91.53.86\
 PRIVATE_IP=172.31.14.183\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=esp\
 DATASET_LABEL=$DATASET_LABEL\
...
# Conll dutch
# tacl-eer_ned_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.237.235.115\
 PRIVATE_IP=172.31.12.39\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=ned\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto english
# tacl-eer_eng-o_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.227.22.71\
 PRIVATE_IP=172.31.6.202\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=eng-o\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto chinese
# tacl-eer_chi_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.235.231.174\
 PRIVATE_IP=172.31.0.96\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=chi\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto arabic
# tacl-eer_ara_ee_raw-short
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.239.242.98\
