# Run raw on the EE annotated docs, dropping all unannotated docs
...
# Conll english
# tacl-eer_eng-c_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=34.232.64.236\
 PRIVATE_IP=172.31.55.33\
...
# Conll german
# tacl-eer_deu_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.237.13.229\
 PRIVATE_IP=172.31.53.216\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=deu\
 DATASET_LABEL=$DATASET_LABEL\
...
# Conll spanish
# tacl-eer_esp_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=35.172.218.70\
 PRIVATE_IP=172.31.48.135\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=esp\
 DATASET_LABEL=$DATASET_LABEL\
...
# Conll dutch
# tacl-eer_ned_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=44.192.24.212\
 PRIVATE_IP=172.31.51.253\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=ned\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto english
# tacl-eer_eng-o_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.239.92.145\
...
# Onto chinese
# tacl-eer_chi_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.231.226.19\
 PRIVATE_IP=172.31.48.201\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=chi\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto arabic
# tacl-eer_ara_ee_raw-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=34.229.131.148\
 PRIVATE_IP=172.31.56.148\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=ara\
 DATASET_LABEL=$DATASET_LABEL\
