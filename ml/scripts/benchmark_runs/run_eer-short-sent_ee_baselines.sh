...
# Conll english
# tacl-eer_eng-c_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=44.192.9.187\
 PRIVATE_IP=172.31.12.133\
...
# Conll german
# tacl-eer_deu_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=54.91.38.44\
 PRIVATE_IP=172.31.8.52\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=deu\
 DATASET_LABEL=$DATASET_LABEL\
...
# Conll spanish
# tacl-eer_esp_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.239.182.98\
 PRIVATE_IP=172.31.1.142\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=esp\
 DATASET_LABEL=$DATASET_LABEL\
...
# Conll dutch
# tacl-eer_ned_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.235.233.161\
 PRIVATE_IP=172.31.1.216\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=ned\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto english
# tacl-eer_eng-o_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.239.207.118\
 PRIVATE_IP=172.31.1.239\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=eng-o\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto chinese
# tacl-eer_chi_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.239.52.9\
 PRIVATE_IP=172.31.2.249\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=chi\
 DATASET_LABEL=$DATASET_LABEL\
...
# Onto arabic
# tacl-eer_ara_ee_eer-short-sent
bash scripts/run_remote_ml_experiment.sh\
 PUBLIC_IP=3.238.22.189\
 PRIVATE_IP=172.31.10.245\
 RUN_JUPYTER=$RUN_JUPYTER\
 RUN_TENSORBOARD=$RUN_TENSORBOARD\
 LANG_LABEL=ara\
 DATASET_LABEL=$DATASET_LABEL\
